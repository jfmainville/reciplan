...
This repository contains the code for the recipe planner and tracker application made with React-Native.
...
1. Execute the below command to download the repository to the local machine:
   ...
   `git clone https://github.com/jfmainville/reciplan.git`
